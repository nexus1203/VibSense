...
const char HTTP_HELP[] PROGMEM =
    ...
    "</table>"
    "<p/>Github <a href='https://www.pmc.org.tw'>https://www.pmc.org.tw</a>.";
#else
const char HTTP_HELP[] PROGMEM = "";
#endif
...
#ifdef ESP32
const char HTTP_INFO_esphead[] PROGMEM = "<h3>PMC EOG Module</h3><hr><dl>";
...
#elif defined(ESP32)
const char S_ssidpre[] PROGMEM = "PMC EOG";
#else
